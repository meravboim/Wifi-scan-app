...
public class gui_filter_time extends gui{
	 ...
	 */
	public static void time_filer_Screen() {
	...
	private void initialize() {
		...
		springLayout.putConstraint(SpringLayout.WEST, time_max, 2, SpringLayout.EAST, textPane_1);
		springLayout.putConstraint(SpringLayout.SOUTH, textPane_1, 0, SpringLayout.SOUTH, time_max);
		...
		springLayout.putConstraint(SpringLayout.NORTH, time_max, 9, SpringLayout.SOUTH, dataMax);
		...
		springLayout.putConstraint(SpringLayout.NORTH, btnCancel, 0, SpringLayout.NORTH, btnApply);
